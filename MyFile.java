...
public class MyFile{
	...
	public void writeInFile(String s){
		...
		*/
		try{
			file = new File("fileio/Memo.txt");	//Declaring a file named named History.txt for creating.
	...
	public void removeFromFile(){
		try{
			//File file = new File("fileio/Memo.txt");
			...
			String line = "", temp2;
			while((temp2 = bfreader.readLine()) != null){
				line = line + temp2;
			}
			line = line.replace(deleteProduct, "");
			pw.println(line);
			bfreader.close();
			pw.close();
			file.delete();
